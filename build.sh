...
xcodebuild -create-xcframework -framework "RecogLib_iOS_simulator/RecogLib_iOS.framework" -framework "RecogLib_iOS_device/RecogLib_iOS.framework" -framework "RecogLib_macOS/RecogLib_iOS.framework" -output RecogLib_iOS.xcframework
