...
protocol PACEHandler {
    func doPACE(mrzKey: String)
}
...
//        }
//        
//        ApplicationLogger.shared.Info( "Performing PACE with \(paceInfo.getProtocolOIDString())" )
//        
...
//        
//        // Temporary logging
//        ApplicationLogger.shared.Verbose("doPace - inpit parameters" )
//        ApplicationLogger.shared.Verbose("paceOID - \(paceOID)" )
//        ApplicationLogger.shared.Verbose("parameterSpec - \(parameterSpec)" )
//        ApplicationLogger.shared.Verbose("mappingType - \(mappingType!)" )
//        ApplicationLogger.shared.Verbose("agreementAlg - \(agreementAlg)" )
//        ApplicationLogger.shared.Verbose("cipherAlg - \(cipherAlg)" )
//        ApplicationLogger.shared.Verbose("digestAlg - \(digestAlg)" )
//        ApplicationLogger.shared.Verbose("keyLength - \(keyLength)" )
//        ApplicationLogger.shared.Verbose("keyLength - \(mrzKey)" )
//        ApplicationLogger.shared.Verbose("paceKey - \(binToHexRep(paceKey, asArray:true))" )
//
...
//        ApplicationLogger.shared.Debug("PACE SUCCESSFUL" )
//    }
//    
...
//        ApplicationLogger.shared.Error( "PACEHandler: \(stage) - \(error)" )
//        ApplicationLogger.shared.Error( "   OpenSSLError: \(OpenSSLUtils.getOpenSSLError())" )
...
//        ApplicationLogger.shared.Debug("Doing PACE Step1...")
...
//        ApplicationLogger.shared.Verbose( "Encrypted nonce - \(binToHexRep(encryptedNonce, asArray:true))" )
//
...
//        }
//
//        ApplicationLogger.shared.Verbose( "Decrypted nonce - \(binToHexRep(decryptedNonce, asArray:true) )" )
...
//        ApplicationLogger.shared.Debug( "Doing PACE Step2...")
//        switch(mappingType) {
//            case .CAM, .GM:
//                ApplicationLogger.shared.Debug( "   Using General Mapping (GM)...")
//                return try await doPACEStep2GM(passportNonce: passportNonce)
//            case .IM:
//                ApplicationLogger.shared.Debug( "   Using Integrated Mapping (IM)...")
...
//        }
//        ApplicationLogger.shared.Verbose( "public mapping key - \(binToHexRep(pcdMappingEncodedPublicKey, asArray:true))")
//
//        ApplicationLogger.shared.Debug( "Sending public mapping key to passport..")
...
//            
//        ApplicationLogger.shared.Debug( "Received passports public mapping key")
//        ApplicationLogger.shared.Verbose( "   public mapping key - \(binToHexRep(piccMappingEncodedPublicKey, asArray: true))")
//
...
//            ApplicationLogger.shared.Debug( "Doing DH Mapping agreement")
...
//            ApplicationLogger.shared.Debug( "Doing ECDH Mapping agreement")
...
//        ApplicationLogger.shared.Debug( "Doing PACE Step3 - Key Exchange")
//
...
//        }
//        
//        ApplicationLogger.shared.Debug( "Generated Ephemeral key pair")
//
...
//        }
//        ApplicationLogger.shared.Verbose( "Ephemeral public key - \(binToHexRep(publicKey, asArray: true))")
//
//        // exchange public keys
//        ApplicationLogger.shared.Debug( "Sending ephemeral public key to passport")
...
//            throw NfcDocumentReaderError.PACEError( "Step3 KeyEx", "Unable to decode passports ephemeral key" )
//        }
//
//        ApplicationLogger.shared.Verbose( "Received passports ephemeral public key - \(binToHexRep(passportEncodedPublicKey!, asArray: true))" )
...
//        ApplicationLogger.shared.Debug( "Doing PACE Step4 Key Agreement...")
//
//        ApplicationLogger.shared.Debug( "Computing shared secret...")
//        let sharedSecret = OpenSSLUtils.computeSharedSecret(privateKeyPair: pcdKeyPair, publicKey: passportPublicKey)
//        ApplicationLogger.shared.Verbose( "Shared secret - \(binToHexRep(sharedSecret, asArray:true))")
//
//        ApplicationLogger.shared.Debug( "Deriving ksEnc and ksMac keys from shared secret")
...
//        ApplicationLogger.shared.Verbose( "encKey - \(binToHexRep(encKey, asArray:true))")
//        ApplicationLogger.shared.Verbose( "macKey - \(binToHexRep(macKey, asArray:true))")
//
//        // Step 4 - generate authentication token
//        ApplicationLogger.shared.Debug( "Generating authentication token")
//        guard let pcdAuthToken = try? generateAuthenticationToken( publicKey: passportPublicKey, macKey: macKey) else {
//            throw NfcDocumentReaderError.PACEError( "Step3 KeyAgreement", "Unable to generate authentication token using passports public key" )
//        }
//        ApplicationLogger.shared.Verbose( "authentication token - \(pcdAuthToken)")
//
//        ApplicationLogger.shared.Debug( "Sending auth token to passport")
...
//        
//        ApplicationLogger.shared.Verbose( "Expecting authentication token from passport - \(expectedPICCToken)")
//
//        let piccToken = [UInt8](tvlResp[0].value)
//        ApplicationLogger.shared.Verbose( "Received authentication token from passport - \(piccToken)")
//
//        guard piccToken == expectedPICCToken else {
//            ApplicationLogger.shared.Error( "Error PICC Token mismatch!\npicToken - \(piccToken)\nexpectedPICCToken - \(expectedPICCToken)" )
//            throw NfcDocumentReaderError.PACEError( "Step3 KeyAgreement", "Error PICC Token mismatch!\npicToken - \(piccToken)\nexpectedPICCToken - \(expectedPICCToken)" )
//        }
//        
//        ApplicationLogger.shared.Debug( "Auth token from passport matches expected token!" )
//        
...
//            ApplicationLogger.shared.Info( "Restarting secure messaging using DESede encryption")
...
//            ApplicationLogger.shared.Info( "Restarting secure messaging using AES encryption")
...
//        }
//        
//        ApplicationLogger.shared.Verbose( "Generating Authentication Token" )
//        ApplicationLogger.shared.Verbose( "EncodedPubKey = \(binToHexRep(encodedPublicKeyData, asArray: true))" )
//        ApplicationLogger.shared.Verbose( "macKey = \(binToHexRep(macKey, asArray: true))" )
//
...
//        ApplicationLogger.shared.Verbose( "Generated authToken = \(binToHexRep(authToken, asArray: true))" )
//        return authToken
//    }
//    
...
//            ApplicationLogger.shared.Error( "PACEHandler: encodePublicKey() - Unable to get public key data" )
