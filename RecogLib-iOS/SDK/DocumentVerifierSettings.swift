...
public struct DocumentVerifierSettings: Equatable {
    ...
    public init(specularAcceptableScore: Int = 50, documentBlurAcceptableScore: Int = 50, timeToBlurMaxToleranceInSeconds: Int = 10, showTimer: Bool = false, showAimingCircle: Bool = false, drawOutline: Bool = true, readBarcode: Bool = true, visualizerVersion: Int = 2
) {
